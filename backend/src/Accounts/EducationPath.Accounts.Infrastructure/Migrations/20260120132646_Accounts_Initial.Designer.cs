...
namespace EducationPath.Accounts.Infrastructure.Migrations
{
    ...
    [Migration("20260120132646_Accounts_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EducationPath.Accounts.Domain.RefreshTokens.RefreshSession", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("EducationPath.Accounts.Domain.Roles.Permission", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("EducationPath.Accounts.Domain.Roles.Role", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("EducationPath.Accounts.Domain.Roles.RolePermission", b =>
                {
            ...
            modelBuilder.Entity("EducationPath.Accounts.Domain.Users.AdminAccount", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("EducationPath.Accounts.Domain.Users.StudentAccount", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("UserId")
                        .IsUnique()
                        .HasDatabaseName("ix_student_accounts_user_id");

                    b.ToTable("student_accounts", "accounts");
                });

            modelBuilder.Entity("EducationPath.Accounts.Domain.Users.User", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ComplexProperty<Dictionary<string, object>>("FullName", "EducationPath.Accounts.Domain.Users.User.FullName#FullName", b1 =>
                        {
                            b1.IsRequired();
            ...
            modelBuilder.Entity("EducationPath.Accounts.Domain.RefreshTokens.RefreshSession", b =>
                {
                    b.HasOne("EducationPath.Accounts.Domain.Users.User", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("EducationPath.Accounts.Domain.Roles.RolePermission", b =>
                {
                    b.HasOne("EducationPath.Accounts.Domain.Roles.Permission", "Permission")
                    ...
                    b.HasOne("EducationPath.Accounts.Domain.Roles.Role", "Role")
                        .WithMany("RolePermissions")
            ...
            modelBuilder.Entity("EducationPath.Accounts.Domain.Users.AdminAccount", b =>
                {
                    b.HasOne("EducationPath.Accounts.Domain.Users.User", "User")
                        .WithOne()
                        .HasForeignKey("EducationPath.Accounts.Domain.Users.AdminAccount", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
            ...
            modelBuilder.Entity("EducationPath.Accounts.Domain.Users.StudentAccount", b =>
                {
                    b.HasOne("EducationPath.Accounts.Domain.Users.User", "User")
                        .WithOne()
                        .HasForeignKey("EducationPath.Accounts.Domain.Users.StudentAccount", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_student_accounts_users_user_id");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<System.Guid>", b =>
                {
                    b.HasOne("EducationPath.Accounts.Domain.Roles.Role", null)
                        .WithMany()
                        .HasForeignKey("RoleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<System.Guid>", b =>
                {
                    b.HasOne("EducationPath.Accounts.Domain.Users.User", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
